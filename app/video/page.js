...
export default function Page() {
  ...
  return (
    <>
      <Header />{" "}
      {/* https://damisaalex.xyz/hngx5/api/videos/651b4df0133eb2651899911f */}
      {loading ? (
        <Loader />
      ) : (
        <>
          <section className=" mt-12 container mx-auto ml10">
            ...
            <div className="hidden md:flex flex-col-reverse mb-16 md:flex-row">
              <div className="w-[50%] minw-[600px] flex flex-col p-10 space-y-9">
                <p className=" font-bold text-4xl font-sora">
                  Your video is ready!
                </p>
                <div className="content w-[530px] h-[68px] space-y-11">
                  <div className="flex flex-col space-y-2">
                    <span className=" text-lg font-sora">Name</span>
                    <span className="flex items-center text-xl font-semibold font-sora text-slate-600">
                  ...
                  <div className="flex justify-between  bg-gray-400 bg-opacity-20 border border-gray-200 rounded-[16px] px-6 py2 py-[10px] ">
                    <input
                      type="text"
                      className="wfull w-[80%] bg-transparent outline-none px6 py3 placeholder:text-neutral-700 placeholder:text-opacity-80 placeholder:font-work"
                  ...
                  <div className="share flex flex-col space-y-3">
                    ...
                    <div className="flex space-x-5">
                      <button className="flex px-[13px] py-2.5 bg-white text-[#120B48] border border-[#120B48] rounded-lg text-base font-medium font-inter">
                        <span className="mr-2">
                          <svg
                            width="25"
                            height="24"
              ...
              <div className=" flex flex-col w-[50%] border-l-2 border-[#BBBBBB] pl-10 p-3">
                ...
                {/* Transcript */}
                <div className=" mt-14">
                  <span className=" font-semibold text-2xl font-sora">
                    Transcript
                  </span>
                </div>
                ...
                <div className="mt-3">
                  <select
                    id="language"
                    className="border py-1 pl-1 pr-16 rounded-[4px] outline-none text-[#9D9D9D] font-work"
                  >
                    <option value="english">English</option>
                    <option value="French">French</option>
                    <option value="Spanish">Spanish</option>
                    <option value="Arabic">Arabic</option>
                    {/* after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[70px] after:bg-gradient-to-b after:from-[#ffffff33] after:to-[#ffff] */}
                  </select>
                </div>
                {/* Transcript Content */}
          ...
          <div className="hidden md:flex justify-center items-center bg-[#E7E7ED] bg-gray200 wfull bg-opacity-20 mb-10">
            <div className="flex flex-col space-y-10 p-10">
              <span className="text-[#141414] text-2xl font-semibold font-sora text-center">
                To ensure the availability and privacy of your video, <br /> we
                recommend saving it to your account.
              </span>
              <button className="flex items-center justify-center mx-auto py-4 px-8 font-medium font-work rounded-lg  text-slate-50 bg-[#120B48] hover:opacity-90">
                Save Video
              </button>
              <div className=" font-semibold font-sora  text-2xl text-center">
                <span className=" text-[#7E7E7E]">Don’t have an account?</span>{" "}
                <span className=" underline text-[#120B48]">
                  Create account
                </span>
              </div>
            </div>
